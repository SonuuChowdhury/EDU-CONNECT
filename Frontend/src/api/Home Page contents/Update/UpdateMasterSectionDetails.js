...
export default async function UpdateMasterSectionDetails(FileData, ItemData, DeleteItem) {
    try {
        ...
        if(DeleteItem){
            try{
                const UpdateOnDataBaseStatus = await axios.put('https://educore-institue-manager.onrender.com/api/update/mastersecetion',{
                    deleteItem:true,
                    itemID:ItemData._id
                },{
                    headers: {
        ...
        if(fileUpdating){
            ...
            const UpdateOnDataBaseStatus = await axios.put('advanced-institute-management-portal.onrender.com/api/update/mastersecetion',{
                itemID:ItemData._id,
                url:ItemData.link,
                tittle:ItemData.title
            },{
